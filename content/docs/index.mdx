---
title: AI实验室 · DIY 智能办公室方案与实施
description: 从现状、设计、实施到验收维护的智能办公室项目文档入口。
---

按“了解现状 → 完成设计 → 现场实施 → 验收维护”推进，让每项决定都有依据、每次变更都可追溯。

## 先选择你的任务

| 任务 | 建议入口 |
| --- | --- |
| 🧭 第一次查看：了解文档库、项目路径、导航和搜索 | [打开使用指南](/guide/getting-started/) |
| 📐 做方案：核对办公室布局，再设计网络与智能化系统 | [从空间布局开始](/guide/office-layout/) |
| 🔧 现场实施：按清单、试点和验收标准推进 | [查看施工与验收](/management/acceptance/) |
| 🗂️ 维护项目：记录方案、任务、变更和重要决定 | [了解协作流程](/guide/workflow/) |

## 项目现在在哪里？

<Callout type="warn" title="当前阶段：方案梳理与现场确认">
...
<Callout title="快速找到内容">

点击页面顶部的搜索框，或按 `⌘ K`（macOS）/ `Ctrl K`（Windows、Linux），输入房间、设备、协议或任务名称，即可直接跳到相关页面标题。

</Callout>

<Callout type="info" title="记录原则">
